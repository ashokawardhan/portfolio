...
const TimelineContent = () => (
    <VerticalTimeline>
        ...
        >
            ...
            <p>How to use webpack from start in React application</p>
            <p>
                <Button
                    variant="contained"
                    color="primary"
                    onClick={() =>
                        openNewTab(
                            "https://www.udemy.com/certificate/UC-EKR3R6J0/"
                        )
                    }
                >
                    Webpack cerificate
        ...
        >
            ...
            <p>How to use React Native and Redux together in an application</p>
            <p>
                <Button
                    variant="contained"
                    color="primary"
                    onClick={() =>
                        openNewTab(
                            "https://www.udemy.com/certificate/UC-QOYOPJMZ/"
                        )
                    }
                >
        ...
        >
            ...
            <p>How to create gamification around normal website activites</p>
            <p>
                <Button
                    variant="contained"
                    color="primary"
                    onClick={() =>
                        openNewTab(
                            "https://www.udemy.com/certificate/UC-K8MCMHAR/"
                        )
                    }
                >
